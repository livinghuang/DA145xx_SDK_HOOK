...
static const struct app_lecb_callbacks user_app_lecb_callbacks = {
    .app_lecb_disconnect_ind            = user_app_lecb_disconnect_ind,
    .app_lecb_connect_req_ind           = user_app_lecb_connect_req_ind,
    .app_lecb_connect_ind               = user_app_lecb_connect_ind,
    .app_lecb_add_ind                   = user_app_lecb_add_ind,
    .app_lecb_data_recv_ind             = user_app_lecb_data_recv_ind,
    .app_lecb_data_send_rsp             = user_app_lecb_data_send_rsp,
};
