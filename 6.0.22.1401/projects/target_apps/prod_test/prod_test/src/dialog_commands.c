                                            ...
                                            ke_task_id_t const src_id)
{
    ...
    arch_asm_delay_us(125); // Wait some time for UART reset.
                                                 ...
                                                 ke_task_id_t const src_id)
{
    ...
    if (!xtal_enabled)
    {
        ...
        arch_asm_delay_us(200000); // 200msec
    }
