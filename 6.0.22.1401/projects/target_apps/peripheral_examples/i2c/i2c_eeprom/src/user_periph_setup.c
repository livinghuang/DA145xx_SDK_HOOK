...
void periph_init(void)
{
    ...
    // Select FPGA GPIO_MAP 2 to work with the FPGA add-on board I2C EEPROM memory
    // disable debugger because P02 (default SW_CLK) is used for I2C_SDA
    FPGA_HELPER(FPGA_GPIO_MAP_2, NO_SWD);
