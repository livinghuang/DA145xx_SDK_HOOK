...
#ifndef _IOD3081_INCLUDED
#define _IOD3081_INCLUDED
...
// -------------------------------------------------------------------------------------
//
// Description: "D3081.h" (Datasheet #7084)
//              C header file of the device registers and bit fields
//              Generated by DoxBox on Jun 27, 2023 12:38:31
//
// -------------------------------------------------------------------------------------
//
...
#define CLK_RC32M_REG_RESET                  (0x00000790)
...
#define XTAL32M_START_REG_RESET              (0x00000032)
...
#define DCDC_SLP_CTRL_REG                    (0x50000056) /* Control of DCDC in sleep */
#define DCDC_SLP_CTRL_REG_RESET              (0x00000090)

/*=============================*/
struct __DCDC_SLP_CTRL_REG
/*=============================*/
{
    volatile uint16_t BITFLD_DCDC_SLP_ENABLE                   : 1;
    volatile uint16_t BITFLD_DCDC_SLP_INTERVAL                 : 3;
    volatile uint16_t BITFLD_DCDC_SLP_UPDATE_INTERVAL          : 1;
    volatile uint16_t BITFLD_DCDC_SLP_OFFSET                   : 3;
};
#define DCDC_SLP_ENABLE                       (0x0001)
#define DCDC_SLP_INTERVAL                     (0x000E)
#define DCDC_SLP_UPDATE_INTERVAL              (0x0010)
#define DCDC_SLP_OFFSET                       (0x00E0)



#define LDO_CORE_LEVEL_REG                   (0x50000058) /* Control the LDO CORE voltage output */
#define LDO_CORE_LEVEL_REG_RESET             (0x00000000)

/*=============================*/
struct __LDO_CORE_LEVEL_REG
/*=============================*/
{
    volatile uint16_t BITFLD_LDO_CORE_LEVEL                    : 3;
};
#define LDO_CORE_LEVEL                        (0x0007)
...
#define PULL_HW_BYPASS_REG                   (0x50000314) /* Control the muxes for P0_1 pull up and down */
#define PULL_HW_BYPASS_REG_RESET             (0x00000001)

/*=============================*/
struct __PULL_HW_BYPASS_REG
/*=============================*/
{
    volatile uint16_t BITFLD_PULL_HW_BYPASS                    : 1;
};
#define PULL_HW_BYPASS                        (0x0001)
...
#define DCDC_CTRL1_REG                       (0x50000082) /*  */
#define DCDC_CTRL1_REG_RESET                 (0x0000003F)

/*=============================*/
struct __DCDC_CTRL1_REG
/*=============================*/
{
    volatile uint16_t BITFLD_DCDC_ILIM_SLP                     : 4;
    volatile uint16_t BITFLD_DCDC_FIX_ILIM_SLP                 : 1;
    volatile uint16_t BITFLD_DCDC_LEVEL1V1_BUMP                : 1;
};
#define DCDC_ILIM_SLP                         (0x000F)
#define DCDC_FIX_ILIM_SLP                     (0x0010)
#define DCDC_LEVEL1V1_BUMP                    (0x0020)
...
#define TEST_CTRL5_REG                       (0x50003042) /* Test Control Register 5 */
...
/*=============================*/
{
    volatile uint16_t BITFLD_RADIO_CP_TEST_SEL                 : 1;
    volatile uint16_t BITFLD_RADIO_CP_TEST_EN                  : 1;
    volatile uint16_t BITFLD_RADIO_CP_BIAS_TRIM                : 2;
};
#define RADIO_CP_TEST_SEL                     (0x0001)
#define RADIO_CP_TEST_EN                      (0x0002)
#define RADIO_CP_BIAS_TRIM                    (0x000C)
...
#define CHIP_ID1_REG_RESET                   (0x00000033)
...
#define CHIP_ID2_REG_RESET                   (0x00000030)
...
#define CHIP_ID3_REG_RESET                   (0x00000038)
...
#define CHIP_ID4_REG_RESET                   (0x00000031)
...
#define CHIP_SWC_REG                         (0x50003210)
...
#define CHIP_REVISION_REG                    (0x50003214)
...
#define CHIP_TEST1_REG                       (0x500032F8)
#define CHIP_TEST1_REG_RESET                 (0x00000042)
...
#define CHIP_TEST2_REG                       (0x500032FC)
...
/*=============================*/
{
    volatile uint32_t BITFLD_OTPC_PADDR                        : 12;
};
#define OTPC_PADDR                            (0x0FFF)
...
#define OTPC_TIM1_REG_RESET                  (0x0999100F)

/*=============================*/
struct __OTPC_TIM1_REG
/*=============================*/
{
    volatile uint32_t BITFLD_OTPC_TIM1_CC_T_1US                : 8;
    volatile uint32_t BITFLD_OTPC_TIM1_CC_T_20NS               : 3;
             uint32_t                                          : 1;
    volatile uint32_t BITFLD_OTPC_TIM1_CC_T_RD                 : 4;
...
#define OTPC_TIM1_CC_T_1US                    (0x00FF)
#define OTPC_TIM1_CC_T_20NS                   (0x0700)
#define OTPC_TIM1_CC_T_RD                     (0xF000)
...
/*=============================*/
{
    volatile uint32_t BITFLD_OTPC_CELADR                       : 12;
};
#define OTPC_CELADR                           (0x0FFF)
...
/*=============================*/
{
    volatile uint32_t BITFLD_OTPC_NWORDS                       : 12;
};
#define OTPC_NWORDS                           (0x0FFF)
...
#define SPI_PAUSE_CTRL_REG                   (0x50001234) /* SPI pause control register */
#define SPI_PAUSE_CTRL_REG_RESET             (0x00000000)

/*=============================*/
struct __SPI_PAUSE_CTRL_REG
/*=============================*/
{
    volatile uint16_t BITFLD_SPI_PAUSE_CLOCKS                  : 8;
    volatile uint16_t BITFLD_SPI_PAUSE_EN                      : 1;
    volatile uint16_t BITFLD_SPI_PAUSE_DATA_READY_EN           : 1;
    volatile uint16_t BITFLD_SPI_PAUSE_CLOCK_EN                : 1;
    volatile uint16_t BITFLD_SPI_PAUSE_READY_ACTIVE_HIGH       : 1;
    volatile uint16_t BITFLD_SPI_PAUSE_DATA_RDY_IS_MISO        : 1;
};
#define SPI_PAUSE_CLOCKS                      (0x00FF)
#define SPI_PAUSE_EN                          (0x0100)
#define SPI_PAUSE_DATA_READY_EN               (0x0200)
#define SPI_PAUSE_CLOCK_EN                    (0x0400)
#define SPI_PAUSE_READY_ACTIVE_HIGH           (0x0800)
#define SPI_PAUSE_DATA_RDY_IS_MISO            (0x1000)
...
#define OTPC_TEST_REG                        (0x07F40024)
...
/*=============================*/
{
    volatile uint32_t BITFLD_OTPC_TEST_MODE                    : 2;
    volatile uint32_t BITFLD_OTPC_TEST_ECC_EN_DE               : 1;
             uint32_t                                          : 5;
    volatile uint32_t BITFLD_OTPC_TEST_ECC_IN                  : 6;
             uint32_t                                          : 2;
    volatile uint32_t BITFLD_OTPC_TEST_ECC_OUT                 : 6;
             uint32_t                                          : 2;
    volatile uint32_t BITFLD_OTPC_TEST_ECC_ERR                 : 1;
};
#define OTPC_TEST_MODE                        (0x0003)
#define OTPC_TEST_ECC_EN_DE                   (0x0004)
#define OTPC_TEST_ECC_IN                      (0x3F00)
#define OTPC_TEST_ECC_OUT                     (0x3F0000)
#define OTPC_TEST_ECC_ERR                     (0x1000000)
...
/*=============================*/
{
    ...
    volatile uint32_t BITFLD_MIXER_IP2_DAC_EXTEND_RANGE        : 1;
};
#define MIXER_IP2_DAC_I_TRIM                  (0x01FF)
#define MIXER_IP2_DAC_Q_TRIM                  (0x1FF0000)
#define MIXER_IP2_DAC_EXTEND_RANGE            (0x2000000)
...
#define RF_LDO_CTRL_REG_RESET                (0x00190777)
...
/*=============================*/
{
    volatile uint32_t BITFLD_CP_EN_DCF_RX                      : 5;
    volatile uint32_t BITFLD_CP_EN_DCF_TX                      : 5;
};
#define CP_EN_DCF_RX                          (0x001F)
#define CP_EN_DCF_TX                          (0x03E0)
...
/*=============================*/
{
    ...
    volatile uint32_t BITFLD_VPASETTLE                         : 2;
             uint32_t                                          : 2;
    volatile uint32_t BITFLD_RXDIV_LKGFIX_DIS                  : 1;
};
...
#define RXDIV_LKGFIX_DIS                      (0x10000000)
...
/*=============================*/
{
    ...
    volatile uint16_t BITFLD_DCDC_SLP_INTERVAL_STAT            : 1;
};
...
#define DCDC_SLP_INTERVAL_STAT                (0x2000)
...
#define XTAL32M_CTRL0_REG_RESET              (0x00000069)
...
#define DCDC_TEST2_REG                       (0x50000086)
...
#define DCDC_STATUS1_REG                     (0x50000088)
...
#define DCDC_STATUS2_REG                     (0x5000008A)
...
#define GP_ADC_TRIM_REG                      (0x5000150C)
...
#define MEM_CTRL_REG_RESET                   (0x00000164)

/*=============================*/
struct __MEM_CTRL_REG
/*=============================*/
{
    volatile uint16_t BITFLD_RAM_EMA                           : 3;
    volatile uint16_t BITFLD_RAM_EMAW                          : 2;
    volatile uint16_t BITFLD_ROM_KEN                           : 1;
    volatile uint16_t BITFLD_ROM_EMA                           : 3;
...
#define RAM_EMA                               (0x0007)
#define RAM_EMAW                              (0x0018)
#define ROM_KEN                               (0x0020)
#define ROM_EMA                               (0x01C0)
#define ARB1_AHB_WR_BUFF                      (0x0200)
#define ARB1_AHB2_WR_BUFF                     (0x0400)
#define ARB2_AHB_WR_BUFF                      (0x0800)
#define ARB2_AHB2_WR_BUFF                     (0x1000)
...
#define CLK_RTCDIV_REG                       (0x5000424C) /* Divisor for RTC 100 Hz clock */
