 ...
 * @file i2c.c
 *
 * @brief Implementation of the I2C Low Level Driver for DA14585/586/531/535 devices.
 *
...
#if (!defined (__DA14531_01__) && !defined (__DA14535__)) || defined (__EXCLUDE_ROM_I2C__)
