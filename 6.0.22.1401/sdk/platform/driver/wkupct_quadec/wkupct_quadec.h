...
/// Debounce unit time selection
typedef enum
{
    /// Debounce unit time is 1ms
    WKUPCT_DEB_UNIT_TIME_1MS = 0,

    /// Debounce unit time is 125us
    WKUPCT_DEB_UNIT_TIME_125US = 1,
} wkupct_deb_unit_time_t;
#endif
...
/**
 ****************************************************************************************
 * @brief Set debounce unit time.
 * @warning Shall be called prior to calling @c wkupct_enable_irq and @c wkupct2_enable_irq
 *          functions, in order to set debounce unit time.
 * @param[in] deb_unit_time_sel Debounce unit time selection
 *                                      - WKUPCT_DEB_TIME_UNIT_1MS for 1ms unit time
 *                                      - WKUPCT_DEB_TIME_UNIT_125US for 125us unit time
 ****************************************************************************************
 */
