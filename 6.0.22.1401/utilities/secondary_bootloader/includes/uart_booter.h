...
#define MAX_CODE_LENGTH_SPI         (SDK_SEC_BOOTLOADER_LOAD_IMAGE_SIZE_INIT_VALUE)
#define MAX_CODE_LENGTH_I2C         (SDK_SEC_BOOTLOADER_LOAD_IMAGE_SIZE_INIT_VALUE)
#define SYSRAM_BASE_ADDRESS         (SDK_RAM_1_BASE_ADDR)
#define SOH     (0x01)
#define STX     (0x02)
#define ACK     (0x06)
#define NAK     (0x15)
